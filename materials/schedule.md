...
| **Week** | **Topics** |
|:-------:|:-----------|
| **Week 1** | - 5W & 1H of Project Management <br> - Introduction to Project Management <br> - Myers-Briggs Type Indicator (MBTI) /DISC profiling <br> - Identify Project Manager for Group <br> - Introduction to Software Project Management (SPM) <br> - The fundamental concepts of SPM <br> - The challenges in SPM <br> - The concepts of management control in SPM|
